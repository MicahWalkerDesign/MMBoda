...
export const translations: Translations = {
  en: {
    ...
    'hero.preWeddingCountdownTitle': 'Thursday meet-up',
    'hero.preWeddingTime': '24 September 2026 · 17:30-20:00',
    'hero.preWeddingPlace': 'Chiringuito Marina La Pineda',
    ...
    'day.tbaNote': 'Times are approximate and may shift slightly on the day.',
    ...
    'day.note': 'The current timeline for the big day 🥳',
    'day.e1.title': 'Arrival',
    'day.e1.desc': 'Arrive, settle in and find your seat.',
    'day.e2.title': 'Ceremony',
    'day.e2.desc': 'The moment we say "I do" — bring tissues.',
    'day.e3.title': 'Group Pictures',
    'day.e3.desc': 'Time to gather everyone for photos together.',
    'day.e4.title': 'Cocktail Opens',
    'day.e4.desc': 'Drinks, canapés and time to mingle.',
    'day.e5.title': 'Dinner Starts',
    'day.e5.desc': 'Dinner, speeches and toasts.',
    'day.e6.title': 'Wedding Dance',
    'day.e6.desc': 'Our first dance as newlyweds.',
    'day.e7.title': 'Party',
    'day.e7.desc': 'Hit the dance floor — this is where the magic happens.',
    'day.e8.title': 'Night Conclusion',
    'day.e8.desc': 'A soft landing after a full night of celebration.',
  ...
  es: {
    ...
    'hero.preWeddingCountdownTitle': 'Meet & Greet del jueves',
    'hero.preWeddingTime': '24 de septiembre de 2026 · 17:30-20:00',
    'hero.preWeddingPlace': 'Chiringuito Marina La Pineda',
    ...
    'day.tbaNote':
      'Los horarios son aproximados y pueden variar ligeramente el día de la boda.',
    ...
    'day.note': 'El timeline actual del gran día 🥳',
    'day.e1.title': 'Llegada',
    'day.e1.desc': 'Llegada, acomodación y búsqueda de vuestro sitio.',
    'day.e2.title': 'Ceremonia',
    'day.e2.desc': 'El momento del «sí, quiero» — traed pañuelos.',
    'day.e3.title': 'Fotos de grupo',
    'day.e3.desc': 'Momento para reunirnos todos y hacer fotos juntos.',
    'day.e4.title': 'Apertura del cóctel',
    'day.e4.desc': 'Bebidas, canapés y tiempo para charlar.',
    'day.e5.title': 'Inicio de la cena',
    'day.e5.desc': 'Cena, discursos y brindis.',
    'day.e6.title': 'Baile nupcial',
    'day.e6.desc': 'Nuestro primer baile como recién casados.',
    'day.e7.title': 'Fiesta',
    'day.e7.desc': 'A la pista de baile — aquí ocurre la magia.',
    'day.e8.title': 'Fin de la noche',
    'day.e8.desc': 'Un cierre tranquilo después de una noche llena de celebración.',
  ...
  de: {
    ...
    'hero.preWeddingCountdownTitle': 'Donnerstags Meet & Greet',
    'hero.preWeddingTime': '24. September 2026 · 17:30-20:00',
    'hero.preWeddingPlace': 'Chiringuito Marina La Pineda',
    ...
    'day.tbaNote':
      'Die Zeiten sind ungefähr und können sich am Tag leicht verschieben.',
    ...
    'day.note': 'Der aktuelle Ablauf des großen Tages 🥳',
    'day.e1.title': 'Ankunft',
    'day.e1.desc': 'Ankommen, entspannt einfinden und Plätze suchen.',
    'day.e2.title': 'Trauung',
    'day.e2.desc': 'Der „Ja“-Moment — Taschentücher mitbringen.',
    'day.e3.title': 'Gruppenfotos',
    'day.e3.desc': 'Zeit, alle für gemeinsame Fotos zusammenzubringen.',
    'day.e4.title': 'Cocktail beginnt',
    'day.e4.desc': 'Drinks, Häppchen und Zeit zum Austauschen.',
    'day.e5.title': 'Dinner beginnt',
    'day.e5.desc': 'Abendessen, Reden und Anstoßen.',
    'day.e6.title': 'Hochzeitstanz',
    'day.e6.desc': 'Unser erster Tanz als frisch verheiratetes Paar.',
    'day.e7.title': 'Party',
    'day.e7.desc': 'Auf die Tanzfläche — hier passiert die Magie.',
    'day.e8.title': 'Ende der Nacht',
    'day.e8.desc': 'Ein sanfter Abschluss nach einer ganzen Nacht voller Feier.',
